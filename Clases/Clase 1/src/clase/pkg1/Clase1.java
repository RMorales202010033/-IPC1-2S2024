...
// Importaciones
// Importacion de scanner el cual va a servir para los inputs
 ...
 */
// Pagina con tabla unicode
// https://agostudio.es/tabla-unicode/
public class Clase1 {
    ...
    public static void main(String[] args) {
        // Hack: Si escriben sout y le dan a la tecla tab, les evitaran escribir System.out.println
        ...
        su equivalente seria:
           ['m','e','n','s','a','j','e']
        El objeto de tipo String se debe escribir como se muestra en el ejemplo de abajo, debido a que java declarÃ³ la clase de esa manera.
         */
        ...
        // Realizando una suma desde el mismo println, recordar el uso de parentesis para que no se concatenen los nÃºmeros y se realice la operaciÃ³n
        ...
        // Orden en que se ejecutan las instruccioens de la linea 84
        ...
        System.out.println("El valor de comp1 es: " + ++comp1);
        // Orden en que se ejecutan las instruccioens de la linea 91
        // 1. Imprime lo siguiente: "El valor de comp1 es: "
        ...
        System.out.println("Menor que: " + (comp1 < comp2)); // 9 < 3 = false
        ...
        // El switch evalua todos los casos propuestos y si ninguno se cumple, ejecutara el codigo que esta dentro del default.
        int j = 4;
        switch (j) {
            case 1:
        ...
        if (prueba > prueba2) {
            System.out.println("El valor de prueba 1 es mayor a prueba2.");
        } else {
            System.out.println("El valor de prueba 1 no es mayor a prueba2.");
        }

        // CICLOS
        // El for lleva dentro de los parentesis 3 cosas: la asignacion del valor a la variable que se usara, la condicion la cual siempre que sea
        // verdadera ejecutara el codigo dentro del for, de lo contrario se saldra del ciclo y por ultimo la actualizacion de la variables.
        int valorInicial = 0;
        for (valorInicial = 0; valorInicial < 10; valorInicial++) { // i = i(0) + 1 = 1 
            System.out.println("El valor de valorInicial es: " + valorInicial);
        }
        System.out.println("+++++++++++++++++++++++++++++++");

        for (int i = 0; i < 10; i++) {
            System.out.println("El valor de i en la iteracion actual es: " + i);
        }
        System.out.println("+++++++++++++++++++++++++++++++");

        // El while evalua si la condicion es verdadera, si en dado caso lo es, ejecutara el codigo que tiene dentro, de lo contrario se saldra del ciclo.
        // *Nota: Recordar siempre evaluar que nos ayudara a salir dentro de un ciclo, de lo contrario se ejecutara infinitamente. Por ejemplo si en este
        // caso no se coloca el k++ dentro del while, el codigo se enciclara ya que k siempre sera menor a 10
        int k = 0;
        while (k <= 10) {
        ...
        // El do-while es parecido al while solo que este primero ejecuta el codigo y luego procede a evaluar la condicion del while, si la condicion
        // retorna un positivo se ejecutara de nuevo el codigo dentro del do, de lo contrario se terminara el ciclo y se ejecutaran las siguientes
        // li­neas del programa
        // Para el ejemplo de abajo, la unica manera de salir del ciclo es si option llega ser igual a 2, debido a que 2 != 2 es false
    ...
    public static void menuPrincipal() {
        ...
        System.out.println("-----------------------");
        System.out.print("Escriba el numero dependiendo de la opcion: ");
    }
